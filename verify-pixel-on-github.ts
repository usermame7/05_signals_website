...
async function verifyPixel() {
  ...
  if ('content' in indexHtml) {
    ...
    const hasPixelInit = content.includes("fbq('init', '984887243970027')");
    ...
    const hasNoscript = content.includes('facebook.com/tr?id=984887243970027');
    ...
    if (bodySection && bodySection[0].includes('facebook.com/tr?id=984887243970027')) {
