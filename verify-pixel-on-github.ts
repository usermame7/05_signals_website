...
async function verifyPixel() {
  ...
  if ('content' in indexHtml) {
    ...
    const hasPixelInit = content.includes("fbq('init', '932076202740196')");
    ...
    const hasNoscript = content.includes('facebook.com/tr?id=932076202740196');
    ...
    if (bodySection && bodySection[0].includes('facebook.com/tr?id=932076202740196')) {
