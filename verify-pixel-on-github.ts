...
async function verifyPixel() {
  ...
  if ('content' in indexHtml) {
    ...
    const hasPixelInit = content.includes("fbq('init', '1602827094105622')");
    ...
    const hasNoscript = content.includes('facebook.com/tr?id=1602827094105622');
    ...
    if (bodySection && bodySection[0].includes('facebook.com/tr?id=1602827094105622')) {
