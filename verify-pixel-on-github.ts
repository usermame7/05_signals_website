...
async function verifyPixel() {
  ...
  if ('content' in indexHtml) {
    ...
    const hasPixelInit = content.includes("fbq('init', '1543076753435299')");
    ...
    const hasNoscript = content.includes('facebook.com/tr?id=1543076753435299');
    ...
    if (bodySection && bodySection[0].includes('facebook.com/tr?id=1543076753435299')) {
